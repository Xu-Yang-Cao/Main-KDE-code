...
aa=[y_KDE_200_collapse(1,2:21);y_LSR_4000_collapse(1,2:21);y_LSR_200_collapse(1,2:21);y_MCS_collapse(1,2:21)]';
...
ylabel('Expected collapse loss ratio (%)','FontSize',16,'FontName','Times New Roman');
...
h=legend([H1,H2,H3,H4,J1,J2],'KDE-collapse-200','LSR-collapse-4000','LSR-collapse-200','MCS-collapse-100000','Connected line for KDE','Connected line for MCS','Location','north');
set(h,'Fontsize',8,'LineWidth',0.5);
...
hh=annotation('textbox',[0.15,0.63,0.74,0.22],'LineStyle','none','LineWidth',0.5,'FontWeight','bold','FontAngle','italic','String','Expected collapse loss ratio');
set(hh,'FontName','Times New Roman','Fontsize',11);

for i=1:10
text(0+5*(i-1),3+8*(i-1),num2str(roundn(y_KDE_200_collapse(1,2*i),-3)),'FontName','Times New Roman','Fontsize',8,'FontWeight','bold','FontAngle','italic'); 
text(3+5*(i-1),3+8*(i-1),num2str(roundn(y_MCS_collapse(1,2*i),-3)),'FontName','Times New Roman','Fontsize',8,'FontWeight','bold','FontAngle','italic'); 
end
